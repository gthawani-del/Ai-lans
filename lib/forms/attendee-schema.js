...
export const attendeeAiReadinessSchema=z.object({
...
export const attendeeBuildSchema=z.object({
...
export const attendeeSchema=attendeeProfileSchema
  .merge(attendeeAiReadinessSchema)
  .merge(attendeeBuildSchema)
  .merge(attendeeConsentSchema);
